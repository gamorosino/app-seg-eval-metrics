...
Vendored verbatim from lincbrain/axonsynth
(https://github.com/lincbrain/axonsynth/blob/main/paper_analysis/metrics.py),
with the maintainer's permission for reuse here. No LICENSE file is present
upstream, so this copy carries the same terms as the source until one is
published there.
